...
#' 
#' Prune \code{ODT} or \code{ODRF} from bottom to top with validation data based on prediction error. \code{prune} is a S3 method for class \code{ODT} and \code{ODRF}.
#'
