...
#' @param randDist The probability distribution of the random projection direction from. "Binary", "Norm", "Uniform" denote the \eqn{B\{-1,1\}} 
#' binomial distribution (default), \eqn{N(0,1)} normal distribution and \eqn{U(-1,1)} uniform distribution, respectively.
...
#' list(RotMatFun="makeRotMat", PPFun="makePP",dimX=ncol(X),dimProj=5,numProj=4,prob=0.5))
#' 
#' @export
