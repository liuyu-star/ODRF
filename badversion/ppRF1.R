...
ppRF1 = function(X,y,method='c',FUN="RandMatPPR",paramList=NULL,catMap=NULL,
                ...
                weights=1,numCores=0L,seed=220924,MaxLayer=Inf,numNode=Inf)
{
  ...
  PPtree=function(seed,...){
    ...
    ppForestT=c(ppForestT,ppCART1(X[TDindx,],y[TDindx],method,FUN,paramList,catMap,MaxLayer,
