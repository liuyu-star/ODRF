...
void GBCC(int M, int N, double* Labels, double* Data, int minleaf, int num_labels, 
          int* bcvar, double* bcval, double* minval){
...
void GBCC(int M, int N, double* Labels, double* Data, double* W, int minleaf, 
          int num_labels, int* bcvar, double* bcval, double* minval){
    
    double *sorted_data, *sorted_w;
    double ah, bh, ch, sum_W, sum_l;
    int i, j, cl, nl, mj;
